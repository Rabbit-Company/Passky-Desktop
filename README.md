...
```yaml
wget https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v2.0.5/passky_2.0.5_amd64.deb
sudo dpkg -i passky_2.0.5_amd64.deb
```
### Red Hat based distros
```yaml
wget https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v2.0.5/Passky-2.0.5-1.x86_64.rpm
sudo rpm -i Passky-2.0.5-1.x86_64.rpm
```
### Snap
...
```
### AppImage
1. Download Passky (https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v2.0.5/passky-2.0.5.AppImage)
2. Start passky-2.0.5.AppImage
3. Passky desktop application is now installed
...
```nix
{
  nixpkgs.overlays = [
    (import (builtins.fetchTarball {
      url = https://github.com/Rabbit-Company/Passky-Desktop/archive/refs/tags/v2.0.5.tar.gz;
    }))
  ];
...
```
### AppImage
1. Move passky-2.0.5.AppImage to the trash
2. Empty your trash
