...
## Installation
### Windows
1. Download Passky installer (https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v1.0.1/passky-1.0.1.Setup.exe)
2. Run installer
3. Passky desktop application is now installed
### Debian based distros
```yaml
wget https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v1.0.1/passky_1.0.1_amd64.deb
sudo dpkg -i passky_1.0.1_amd64.deb
```
### Red Hat based distros
```yaml
wget https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v1.0.1/Passky-1.0.1-1.x86_64.rpm
sudo rpm -i Passky-1.0.1-1.x86_64.rpm
```
### Snap
...
```
### AppImage
1. Download Passky (https://github.com/Rabbit-Company/Passky-Desktop/releases/download/v1.0.1/passky-1.0.1.AppImage)
2. Start passky-1.0.1.AppImage
3. Passky desktop application is now installed
## Uninstall
### Windows
...
```
### AppImage
1. Move passky-1.0.1.AppImage to the trash
2. Empty your trash
